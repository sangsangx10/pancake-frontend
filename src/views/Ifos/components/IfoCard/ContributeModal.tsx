...
import { Modal, Button, Flex, LinkExternal } from '@ichikanakano/uikit'
...
const ContributeModal: React.FC<Props> = ({ currency, contract, currencyAddress, onDismiss }) => {
  ...
  return (
    <Modal title={`Contribute ${currency}`} onDismiss={onDismiss}>
      ...
      <LinkExternal
        href="https://exchange.pancakeswap.finance/#/add/ETH/0xa532c7fc2c912db822dbdc14a020c7f1b62b5141"
        style={{ margin: 'auto' }}
      >
        {`Get ${currency}`}
      </LinkExternal>
